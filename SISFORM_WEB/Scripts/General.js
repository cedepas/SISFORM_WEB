...
function GrillaModal(lista, divGrilla, registrosPagina, paginasBloque, sinFiltros) {
    var matriz = [];
    ...
    function mostrarMatriz() {
        ...
        if (nRegistros > 0) {
            ...
            for (var i = inicio; i < fin; i++) {
                if (i < nRegistros) {
                    html += "<tr onclick='seleccionarFila(this);' ondblclick='modalObtenerRegistroPorId(\"";
                    html += matriz[i][0];
                    html += "\");'>";
                    for (var j = 0; j < ncampos; j++) {
                        html += "<td>";
...
//Grilla2
function GrillaModal2(lista, divGrilla, registrosPagina, paginasBloque, sinFiltros) {
    var matriz = [];
    ...
    function mostrarMatriz() {
        ...
        if (nRegistros > 0) {
            ...
            for (var i = inicio; i < fin; i++) {
                if (i < nRegistros) {
                    html += "<tr onclick='seleccionarFila(this);' ondblclick='modalObtenerRegistroPorIdVacuna(\"";
                    html += matriz[i][0];
                    html += "\");'>";
                    for (var j = 0; j < ncampos; j++) {
                        html += "<td>";
